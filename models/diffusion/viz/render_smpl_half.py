...
class BlenderVisualizer():
    ...
    def __init__(self, args):
        ...
        if not self.modified_smplx_viz:                     # FBX based
            ...
            # self.cam_location = (0, -4.7, -0.35) # full body
            self.cam_location = (0, -2.5, 0)     # half body
            if self.person in males:
            ...
            # self.mesh_name = f"SMPLX-mesh-neutral"                              # GT only HACK for V1 MOSH data RENDER since its SMPLX-NEUTRAL FLAME 2020
